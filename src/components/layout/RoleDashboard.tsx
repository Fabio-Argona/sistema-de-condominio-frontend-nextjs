...
export function DashboardPage({ children }: DashboardPageProps) {
  return (
    <div className="min-h-screen w-full bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.10),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(16,185,129,0.08),_transparent_22%),linear-gradient(180deg,_#f8fafc_0%,_#eef2ff_100%)] dark:bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.10),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(16,185,129,0.08),_transparent_22%),linear-gradient(180deg,_#020617_0%,_#0f172a_100%)]">
      <div className="mx-auto flex w-full max-w-7xl justify-center px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <div className="w-full space-y-6 rounded-[28px] border border-white/70 bg-white/80 p-4 shadow-[0_24px_80px_-36px_rgba(15,23,42,0.35)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/82 sm:p-6 lg:p-8">
          {children}
        </div>
      </div>
    </div>
...
export function DashboardHero({ eyebrow, title, description, status, aside }: DashboardHeroProps) {
  return (
    <section className="relative overflow-hidden rounded-[28px] border border-slate-200/70 bg-[linear-gradient(135deg,_rgba(255,255,255,0.96),_rgba(239,246,255,0.92)_52%,_rgba(236,253,245,0.85)_100%)] p-6 shadow-[0_24px_60px_-40px_rgba(14,165,233,0.45)] dark:border-slate-800 dark:bg-[linear-gradient(135deg,_rgba(15,23,42,0.96),_rgba(15,23,42,0.92)_52%,_rgba(6,78,59,0.22)_100%)] lg:p-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {actions.map((action) => (
          <Link
            ...
            href={action.href}
            className={`group rounded-3xl border p-5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg ${action.accent}`}
          >

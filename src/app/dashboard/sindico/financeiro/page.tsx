...
export default function FinanceiroPage() {
  ...
  return (
    <DashboardPage>
      <DashboardHero
        eyebrow="Financeiro"
        title="Caixa, inadimplência e decisões financeiras"
        description="Acompanhe o que entrou no mês, a pressão da inadimplência e a diferença entre receita e despesa estimada sem sair do painel."
        status={
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Badge variant={saldoMes >= 0 ? 'success' : 'warning'}>
              Saldo estimado {saldoMes >= 0 ? 'positivo' : 'pressionado'}
            </Badge>
          </div>
        }
        aside={
          <div className="rounded-[24px] border border-white/70 bg-white/80 p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/80">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="rounded-2xl border border-slate-200/70 bg-slate-50 px-4 py-3 dark:border-slate-800 dark:bg-slate-950">
                <p className="text-xs text-slate-500 dark:text-slate-400">Inadimplência atual</p>
        ...
        actions={[
          {
            ...
            title: 'Inadimplência',
            description: 'Entre na lista operacional de boletos pendentes e vencidos.',
      ...
      />
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <StatsCard
            ...
            color="emerald"
            subtitle="Pagamentos compensados no mês corrente"
            icon={
          ...
          <StatsCard
            ...
            color="red"
            subtitle="Estimativa baseada no volume atual"
            icon={
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <StatsCard
            ...
            color="amber"
            subtitle="Percentual de boletos já vencidos"
            icon={
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
          <Card gradient className="xl:col-span-2">
            <CardHeader>
              <DashboardSectionTitle title="Fluxo de caixa" description="Comparativo visual entre entradas e pressão de saída dos últimos 6 meses." action={<Link href="/dashboard/sindico/relatorios" className="text-sm font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400">Abrir relatório</Link>} />
            </CardHeader>
            <CardContent>
          ...
          <Card gradient>
            <CardHeader>
              <DashboardSectionTitle title="Boletos em atraso" description="Amostra das pendências que mais pressionam a operação." />
            </CardHeader>
